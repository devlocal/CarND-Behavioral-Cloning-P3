...
if __name__ == "__main__":
    ...
    Monitor().run()
    # Monitor(dest_folder="validation").run()

    # n = CsvLog(os.path.join("train", "004 bridge to bridge rev", Monitor.LOG_FILE_NAME)).localize_path_fields()
    # logging.info("Localized path fields in %d rows.", n)

    # MovieFrames(os.path.join("train", "005 bridge to bridge rev 2", "IMG")).make_movies()
